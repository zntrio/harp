...
| link:https://golang.org/x/oauth2[$$golang.org/x/oauth2$$] | v0.0.0-20220608161450-d0670ef3b1eb | BSD-3-Clause
| link:https://golang.org/x/sync[$$golang.org/x/sync$$] | v0.0.0-20220601150217-0de741cfad7f | BSD-3-Clause
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.0.0-20220610221304-9f5ed59c137d | BSD-3-Clause
...
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.0.0-20220607020251-c690dde0001d | BSD-3-Clause
