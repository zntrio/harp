...
import (
	...
	"github.com/zntrio/harp/v1/pkg/tasks/bundle"
)
...
var bundleDecryptCmd = func() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			ctx, cancel := cmdutil.Context(cmd.Context(), "harp-bundle-decrypt", conf.Debug.Enabled, conf.Instrumentation.Logs.Level)
			defer cancel()
